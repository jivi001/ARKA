...
class LLMGateway:
    ...
    def _get_model_string(
        self, provider: LLMProvider, model: str, base_url: str | None = None
    ) -> str:
    ...
    def _build_router(self, settings) -> LiteLLMRouter | None:
        ...
        if (
            ...
            and settings.arka_llm_fallback_model
            and settings.arka_llm_fallback_api_key
        ):
        ...
        providers.append(
            {
                ...
                "role": "primary",
                "configured": bool(
                    settings.arka_llm_api_key.get_secret_value()
                    if settings.arka_llm_api_key
                    else False
                ),
            }
        )
