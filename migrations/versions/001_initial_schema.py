...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_audit_logs_engagement_id"), "audit_logs", ["engagement_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_llm_requests_created_at"), "llm_requests", ["created_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_approvals_engagement_id"), "approvals", ["engagement_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_policy_decisions_engagement_id"),
        "policy_decisions",
        ["engagement_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_policy_decisions_task_id"), "policy_decisions", ["task_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_tool_runs_engagement_id"), "tool_runs", ["engagement_id"], unique=False
    )
